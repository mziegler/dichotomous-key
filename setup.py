...
setup(name='Dichotmous Key', version='1.0',
      description='OpenShift Python-3.3 / Django-1.6 Community Cartridge based application',
      author='Julia Janicki and Matt Ziegler', author_email='jhjanicki@gmail.com, mattpziegler@gmail.com',
      url='http://key-mziegler.rhcloud.com',
